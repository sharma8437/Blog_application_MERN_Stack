...
try {
  ...
  if(data.success){
    ...
    console.log("this is error from blog comments", comments)
  }
  else{
...
<div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
  ...
  <div className='mt-14 mb-10 max-w-3xl mx-auto'>
    <p className='font-semibold mb-3'>Comment ({comments.length})</p>
...
{/* comment box add section  */}
    <div className='max-w-3xl mx-auto'>
      ...
      <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
        ...
        <textarea  placeholder='Comment' required className='w-full p-2 border border-gray-300 outline-none h-48'
