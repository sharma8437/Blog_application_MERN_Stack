  ...
  return (
    <div className='   relative w-full '>
        ...
        <div className='text-center mt-20 mb-8'>
            ...
            <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700'>Create and <span className='text-primary'>share</span> <br/>  your stories</h1>
        ...
        <img src={assets.bgBackground} alt='' className="absolute -top-50 -z-1 opacity-50 w-full h-[550px] md:h-[700px] object-cover" />
        </div>
  )
}
